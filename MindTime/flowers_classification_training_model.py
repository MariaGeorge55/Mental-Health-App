...
image_dir = 'D:/CNNGrad/data/train'
size = 128,128
batch_size = 7
epochs=100
...
def construct_cnn():
    ...
    model.compile(optimizer = 'adam', loss = 'categorical_crossentropy', metrics = ['accuracy'],use_landmarks = True,
...
def init_callbacks():
    ...
    base_path = 'D:/CNNGrad/model_weights/'
